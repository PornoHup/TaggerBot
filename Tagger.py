...
async def mentionall(event):
  ...
  if not event.sender_id in admins:
    return await event.respond("**Bu komutu sadacə yöneticilər istifadə edə bilər 〽️**")
  ...
  if event.pattern_match.group(1):
    ...
    return await event.respond("Tağ etmək üçün səbəb yox🤦🏾‍♂️")
  else:
    return await event.respond("**Tağ etməyə Başlamaq üçün səbəb yazın...!**")
  ...
  if mode == "text_on_cmd":
    ...
    async for usr in client.iter_participants(event.chat_id):
      ...
      if event.chat_id not in anlik_calisan:
        await event.respond("** Tag etmə prosesi uğurla dayandırıldı🤦🏾‍♂️**")
        return
      if usrnum == 5:
  ...
  if mode == "text_on_reply":
    ...
    async for usr in client.iter_participants(event.chat_id):
      ...
      usrtxt += f"[{random.choice(emoji)}](tg://user?id={usr.id}) "
      if event.chat_id not in anlik_calisan:
        await event.respond("Tağ etmə uğurla Dayandırıldı\n\n**Buda sizin reklamınız ola bilər @RiyaddBlog**🐊")
        return
      if usrnum == 5:
...
async def mentionall(event):
  global anlik_calisan
  if event.is_private:
    return await event.respond("Bu ayar qruplar və kanallar üçün keçərli❗️**")
  
  admins = []
  async for admin in client.iter_participants(event.chat_id, filter=ChannelParticipantsAdmins):
    admins.append(admin.id)
  if not event.sender_id in admins:
    return await event.respond("**Bu ayarı sadacə yönəeticilr istifadə edə bilər〽️**")
  ...
  if event.pattern_match.group(1):
    ...
    return await event.respond("Başlatmaq üçün səbəb yoxdu 🤦🏾‍♂️")
  else:
    return await event.respond("Işləmə başlamaq üçün səbəb yox")
  ...
  if mode == "text_on_cmd":
    ...
    async for usr in client.iter_participants(event.chat_id):
      ...
      if event.chat_id not in tekli_calisan:
        await event.respond("**Tağ uğurla Dayandı\n\n**Buda sizin reklamınız ola bilər @RiyaddBlog**🐊****")
        return
      if usrnum == 1:
